...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Zinccoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"zinccointools.com", "10.190.44.11"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"zinccointools.com", "testnet-seed.zinccointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Zinccoin is probably already running."), addrBind.ToString().c_str());
        else
